                                    ...
                                    <table class="table table-striped table-bordered" id="sample_1">
                                        ...
                                        <tbody>
                                            ...
                                            <tr class="odd gradeX">
                                                ...
                                                <td><?php echo '***********************'; ?></td>
                                               <td class="center hidden-phone"><?php echo $Linha['estado'];?></td>
                                                <td class="hidden-phone"><?php echo $Linha['Perfil_Acesso']; ?></td>
                                                ...
                                                <a target="_blank" class="btn btn-small btn-inverse" href="Relatorios/paciente_ficha.php?cod_paciente=<?php echo $Linha['']; ?>"><i class="icon-suitcase">  </i>Imprimir Ficha</a>
                                                </td>
                                            </tr>
                                            <?php } ?>
                                    </tbody>
