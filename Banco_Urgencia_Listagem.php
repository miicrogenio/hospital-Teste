         ...
         <!-- BEGIN SIDEBAR MENU -->
          <ul class="sidebar-menu">
              ...
              <li class="sub-menu">
                  ...
                  <ul class="sub">
                      <li><a class="" href="Paciente_Cadastro.php">Pacientes</a></li>
                      <li><a class="" href="Funcionario_Cadastro.php">Funcionários</a></li>
                      <li><a class="" href="Utilizador_Cadastro.php">Utilizadores</a></li>
      		...
      		<li class="sub-menu">
                  ...
                  <ul class="sub">
                      <li><a class="" href="Consulta_Marcar.php">Marcar consulta</a></li>
                      <li><a class="" href="Consulta_Remarcar.php">Remarcar consulta</a></li>
                      <li><a class="" href="Consulta_Cancelar.php">Cancelar consulta</a></li>
                  </ul>
            </li>
              <li class="sub-menu">
                  <a href="javascript:;" class="">
...
<!--                  <ul class="sub">
                      <li><a class="" href="form_layout.html">Utilizadores</a></li> 
                      <li><a class="" href="form_wizard.html">Funcionários</a></li>
                      <li><a class="" href="form_component.html">Unidades Sanitarias</a></li>
                  </ul>-->
            </li>
              <li class="sub-menu">
                  <a href="javascript:;" class="">
                  ...
                  <ul class="sub">
                  	<li><a class="" href="Paciente_Listagem.php">Pacientes</a></li> 
              ...
              <li class="sub-menu">
                  ...
                  <ul class="sub">
                      <li><a class="" href="Paciente_Listagem.php">Pacientes</a></li> 
                      <li><a class="" href="Logis.php">Acesso ao Sistema</a></li>
                      <li><a class="" href="Logis.php">Funcionários</a></li>
                      <li><a class="" href="Utilizador_Listagem.php">Utilizadores</a></li>
                      <li><a class="" href="Banco_Urgencia_Listagem.php">Banco de urgência</a></li>
                  </ul>
              </li>
