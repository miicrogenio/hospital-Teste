                ...
                <div class="container-fluid">
                    ...
                    <div class="row-fluid">
                        <div class="span12">
                            ...
                            <ul class="breadcrumb">
                                ...
                                <li class="active"> Controlo Diario dos Pacientes Internados</li>
                    ...
                    <div class="widget black">
                        <div class="widget-title">
                            <h4><i class="icon-reorder"></i>  Controlo Diario dos Pacientes Internados</h4>
                            <span class="tools">
                        ...
                        <div class="widget-body">
                            <!-- BEGIN FORM-->
                            <form action="classes/Cadastrar_Consulta_Paciente.php" method="post" class="form-horizontal">
                                ...
                                <div class="form-actions">
                                    <button type="submit" class="btn btn-success"><i class="icon-ok"></i> Gravar Registos</button>
